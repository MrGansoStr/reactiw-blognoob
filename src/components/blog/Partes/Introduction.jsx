	...
	return (
		<>
			...
			<div className="rounded-1 border p-3">
				<h3 id="originc" className="titulo">Origen del C++</h3>
				...
				<hr />
				<h3 id="cmeans" className="titulo">Qué significa C++</h3>
				...
				<hr />
				<h3 id="programingmeans" className="titulo">Que es programar? </h3>
				...
				<hr />
				<h3 id="ingsoft" className="titulo">La ingenieria de Software</h3>
				...
				<hr />
				<h3 id="libs" className="titulo">Librerias</h3>
				...
				<hr />
				<h3 id="errors" className="titulo">Errores: </h3>
				...
				<h4 id="errorssintaxis" className="titulo">Errores de sintaxis: </h4>
				...
				<h4 id="warnigs" className="titulo">Avisos: </h4>
				...
				<h4 id="errorsbound" className="titulo">Errores de enlazado: </h4>
				...
				<h4 id="errorsexecution" className="titulo">Errores de ejecución: </h4>
				...
				<h4 id="errorsdesign" className="titulo">Errores de Diseño:</h4>
				...
				<hr />
				<h3 id="purpouse" className="titulo">Propósito de C++</h3>

  ...
  return (
    <div className="container-xl">
      ...
      <div className="rounded-3 border p-3">
        ...
        <hr/>
        <h3 id="tiposfundamentales" className="titulo">Tipos Fundamentales</h3>
        ...
        <hr />
        <h3 id="char" className="titulo">Tipo "char" o carácter: </h3>
        <p>
        ...
        <hr />
        <h3 id="int" className="titulo">Tipo "int" o entero: </h3>
        <p>
        ...
        <hr />
        <h3 id="float" className="titulo">Tipo "float" o coma flotante: </h3>
        ...
        <hr />
        <h3 id="bool" className="titulo">Tipo "bool" o Booleana:</h3>
        <p>
        ...
        <hr />
        <h4 id="double" className="titulo">Tipo "double o coma flotante de doble precisión: </h4>
        <p>
        ...
        <hr />
        <h4 id="void" className="titulo">Tipo "void" o sin tipo: </h4>
        <p>
